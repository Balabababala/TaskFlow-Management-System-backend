...
public interface TaskService {
		...
		void updateTask(CustomUserDetails customUserDetails,TaskDto taskDto);
		...
		List<TaskDto> findAllWorkflow();

		TaskDto findTaskAdminVer(CustomUserDetails customUserDetails,Long id);
		List<TaskDto> findAllWorkflowAdminVer(CustomUserDetails customUserDetails);
}
